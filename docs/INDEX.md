...
## Lojas e Distribuição (Google Play & F-Droid)

- [`PLAY-STORE-AUTOMACAO.md`](PLAY-STORE-AUTOMACAO.md) — preparação única e CI/CD seguro da Play Developer API
- [`F-DROID.md`](F-DROID.md) — submissão, regras de MR e receita para publicação no F-Droid
- [`../scripts/verify-locales.py`](../scripts/verify-locales.py) — verificação de recursos traduzidos, placeholders e seletor Android
...
- [`backlog/locales-config-incompleto.md`](backlog/locales-config-incompleto.md) — histórico do diagnóstico; configuração corrigida e protegida por `verify-locales.py`
- [`backlog/pt-br-caindo-em-pt-pt.md`](backlog/pt-br-caindo-em-pt-pt.md) — histórico do diagnóstico; `values-pt-rBR` e o seletor explícito foram corrigidos
